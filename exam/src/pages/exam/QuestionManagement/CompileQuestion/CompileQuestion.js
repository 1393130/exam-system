...
import styles from './CompileQuestion.css'
import { Form, Input, Select, Button, Modal,message } from 'antd';

function CompileQuestion(props) {
  if(props.addInfo==1){
...
export default connect(mapToProps, mapDispatchToProps)(Form.create()(CompileQuestion));
